  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "border-b border-[var(--eva-green)]/15 bg-black/80 shadow-[0_4px_30px_rgba(0,0,0,0.5)] backdrop-blur-xl"
      ...
      >
        ...
        >
          ...
          <div className="hidden flex-col leading-none md:flex">
            <span
              className={cn(
                "font-display text-white transition-all duration-300",
            ...
            <span
              className={cn(
                "font-mono-tech uppercase tracking-[0.25em] text-[var(--eva-green)] transition-all duration-300",
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <button
            type="button"
            onClick={() => setPage("home")}
            className="font-mono-tech text-xs uppercase tracking-[0.2em] text-slate-400 transition hover:text-[var(--eva-green)]"
          >
            Comunidad
          </button>
        </nav>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={cn(
              "relative rounded-lg border border-white/10 bg-black/40 transition hover:border-[var(--eva-green)]/50 hover:bg-[var(--eva-green)]/5",
              scrolled ? "p-2" : "p-3"
            )}
          ...
          <button
            type="button"
            className={cn(
              "hidden rounded-lg border border-[var(--eva-green)]/40 bg-[var(--eva-green)]/10 font-mono-tech uppercase tracking-[0.15em] text-[var(--eva-green)] transition hover:bg-[var(--eva-green)]/20 md:block",
              scrolled ? "px-3 py-2 text-[10px]" : "px-4 py-2.5 text-xs"
            )}
          >
            Sync ▸
          </button>
...
// ═══════════════════════════════════════════════════════
function ProfessionalCard({ pro, index }) {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-3 top-3 z-10 font-mono-tech text-[9px] uppercase tracking-wider text-white/60">
        ▸ pro_{String(index + 1).padStart(2, "0")}
      </span>

      {/* Foto 4:5 (aspect ratio Instagram retrato) */}
      <div className={cn("relative aspect-[4/5] overflow-hidden bg-gradient-to-br", category.color)}>
        {/* Grid HUD */}
        <div className="absolute inset-0 eva-grid-bg opacity-30" />

        {/* Esquinas HUD */}
        <div className="pointer-events-none absolute left-2 top-2 h-4 w-4 border-l-2 border-t-2 border-white/40" />
        <div className="pointer-events-none absolute right-2 top-2 h-4 w-4 border-r-2 border-t-2 border-white/40" />
        <div className="pointer-events-none absolute bottom-2 left-2 h-4 w-4 border-b-2 border-l-2 border-white/40" />
        <div className="pointer-events-none absolute bottom-2 right-2 h-4 w-4 border-b-2 border-r-2 border-white/40" />
        ...
        {/* Rating badge en esquina inferior */}
        <div className="absolute bottom-3 left-3 flex items-center gap-1.5 rounded-sm bg-black/70 px-2 py-1 backdrop-blur">
      ...
      <div className="mx-auto max-w-7xl px-5 py-12 md:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_0.7fr_0.7fr_1fr]">
          ...
          <div>
            ...
            <div className="mt-3 flex overflow-hidden rounded-sm border border-white/10 bg-black/40">
              <input
                placeholder="tu@email.com"
                className="min-w-0 flex-1 bg-transparent px-3 py-2.5 font-mono-tech text-xs outline-none placeholder:text-slate-600"
              />
              <button type="button" className="bg-[var(--eva-green)] px-4 font-mono-tech text-xs font-bold text-black hover:bg-white">
                ▸
              </button>
            </div>
          </div>
